...
## Step 209 — 両側を 1 つのプロファイルから作る(M5 H6)
...
| 4 | レビューで訊く 1 問を規約に | 208 |
| 2 | 固有名リテラルの検査 | 208 |
| 1 | 両側を 1 つのプロファイルから作る | **209** |
...
Step 209 完了時点: **2,838 runs / 8,413 assertions / 0 failures / 0 errors / 44 skips**
(Step 208 から +4 runs = プロファイルの検査。skips は増えていない)
(以前) Step 208 完了時点: **2,834 runs / 8,397 assertions / 0 failures / 0 errors / 44 skips**
(Step 207 から +1 run = 固有名リテラルの検査。skips は増えていない)
