/* rubycc bundled <sys/resource.h>: resource limits and usage (POSIX.1).
   ...
   field width), so this header lives in the common layer. struct timeval
...
/* struct rusage: 144 bytes, 8-byte aligned (measured, both arches). The
   ru_ixrss/ru_idrss/ru_isrss/ru_nswap fields are unused by Linux but kept for
   the standard layout, the same way sys/stat.h keeps struct stat's trailing
   reserved longs. */
struct rusage {
